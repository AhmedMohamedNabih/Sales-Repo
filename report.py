...
import streamlit as st
st.set_page_config(layout='wide', initial_sidebar_state='expanded', page_title='Sidebar Test')

st.title("Main")
st.write("If you don't see the sidebar, this file isn't running or the sidebar is collapsed.")
